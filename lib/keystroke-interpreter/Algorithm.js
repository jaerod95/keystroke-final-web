module.exports = {
        ...
        for (page in pairedKeystrokes) {
            ...
            pairedKeystrokes[page].forEach((val, ind, arr) => {
                if (!val.wrongKeyPair) {
                    ...
                    if (results.total[val.code] == null)
                        results.total[val.code] = [];
                    results.total[val.code].push(dwelltime);
                }
            });
        }
        return results;
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Canberra: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Chebyshev: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Czekanowski: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Intersection: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Kulczynski: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Minkowski: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Ruzicka: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Soergel: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Sorensen: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Wavehedges: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Euclidean_Distance: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Mahanobolis_Distance: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Z_Score: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Lorentzian: function(obj) {
        var result = {};
        return result;
    },
     ...
     * @return {JSON}     A JSON object of the Flight Times     *
     ************************************************************/
    algorithm_Manhattan_Distance: function(obj) {
        var result = {};
        return result;
    },
